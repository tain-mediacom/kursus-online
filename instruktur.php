            ...
            <div class="menu">
                <ul>
                    <div class="menu-admin">
                        ...
                        <li><a href="instruktur.php" style="background-color: #0db3dd;"><i class="fa-solid fa-thumbtack"></i> Instruktur</a></li>
                ...
                <div class="table">
                    <table border="1" cellspacing="0">
                        <tr>
                            ...
                            <th class="rowHead">Nama Instruktur</th>
                            <th class="rowHead">Instruktur</th>
